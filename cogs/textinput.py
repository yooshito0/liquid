      ...
      async def callback(self, inter: disnake.ModalInteraction):
        async with aiohttp.ClientSession() as session:
            ...
            if url_1 == None:
              ...
              embed2=disnake.Embed(description='Данный баг был отправлен разработчикам!', color=0x2e2f33)
              embed2.set_author(name='Баг', icon_url='https://cdn.discordapp.com/attachments/951522311033483275/959800642149429338/661226540809453588.gif')
              await inter.response.send_message(embed=embed2, ephemeral=True)
