...
class UtilCommand(commands.Cog):
    ...
    async def random(self, inter, мин, макс):
        if мин > макс:
            ...
            embed.set_author(name='Рандомное число', icon_url='https://cdn.discordapp.com/attachments/951522311033483275/959800642149429338/661226540809453588.gif')
            embed.set_footer(text=f"{inter.author}", icon_url=f"{inter.author.avatar}")
    ...
    async def search(self, inter, поисковик, текст: str):
        ...
        if поисковик == 'Yandex':
          ...
          ja = текст
          ja = ja.replace(' ', '+')
          embed=disnake.Embed(description=f"[Ссылка на ваш запрос](https://yandex.ru/search/?lr=38&text=" + ja + ")", color=0x2e2f33, timestamp=datetime.datetime.now())
          embed.set_footer(text=f"{inter.author}", icon_url=f"{inter.author.avatar}")
          embed.set_author(name='Поиск в Яндексе', icon_url='https://cdn.discordapp.com/attachments/951522311033483275/959800642149429338/661226540809453588.gif')
          ...
          embed=disnake.Embed(description=f"[Ссылка на ваш запрос](https://www.google.com/search?q=" + ja + ")", color=0x2e2f33, timestamp=datetime.datetime.now())
          embed.set_author(name='Поиск в Гугле', icon_url='https://cdn.discordapp.com/attachments/951522311033483275/959800642149429338/661226540809453588.gif')
          embed.set_footer(text=f"{inter.author}", icon_url=f"{inter.author.avatar}")
          ...
          embed=disnake.Embed(description=f"[Ссылка на ваш запрос](https://www.youtube.com/results?search_query=" + ja + ")", color=0x2e2f33, timestamp=datetime.datetime.now())
          embed.set_author(name='Поиск в Ютубе', icon_url='https://cdn.discordapp.com/attachments/951522311033483275/959800642149429338/661226540809453588.gif')
          embed.set_footer(text=f"{inter.author}", icon_url=f"{inter.author.avatar}")
          ...
          embed=disnake.Embed(description=f"[Ссылка на ваш запрос](https://duckduckgo.com/?q=" + ja + ")", color=0x2e2f33, timestamp=datetime.datetime.now())
          embed.set_author(name='Поиск в ДакДакГо', icon_url='https://cdn.discordapp.com/attachments/951522311033483275/959800642149429338/661226540809453588.gif')
          embed.set_footer(text=f"{inter.author}", icon_url=f"{inter.author.avatar}")
          ...
          embed=disnake.Embed(description=f"[Ссылка на ваш запрос](https://go.mail.ru/search?q=" + ja + ")", color=0x2e2f33, timestamp=datetime.datetime.now())
          embed.set_author(name='Поиск в Майле', icon_url='https://cdn.discordapp.com/attachments/951522311033483275/959800642149429338/661226540809453588.gif')
          embed.set_footer(text=f"{inter.author}", icon_url=f"{inter.author.avatar}")
    ...
    async def ships(self, inter, пользователь=None):
        ...
        if пользователь == inter.author:
            ...
            embed = disnake.Embed(
                ...
                color=0x2e2f33, timestamp=datetime.datetime.now())
            embed.set_author(name='Любовь %', icon_url='https://cdn.discordapp.com/attachments/951522311033483275/959800642149429338/661226540809453588.gif')
            embed.set_footer(text=f"Выполнил команду: {inter.author}")
            await inter.response.send_message(embed=embed)
    ...
    async def ball(self, inter, вопрос=None):
        ...
        color=0x2e2f33, timestamp=datetime.datetime.now())
        embed.set_author(name='Шар гаданий', icon_url='https://cdn.discordapp.com/attachments/951522311033483275/959800642149429338/661226540809453588.gif')
        embed.set_footer(text=f"{inter.author}", icon_url=f"{inter.author.avatar}")
        await inter.response.send_message(embed=embed)
